...
export default function Project(){
    return (
        ...
        Explore my work: review the architecture and implementation details, and
         interact with the APIs and backend systems I’ve built.
        </p>
        ...
        {Projects.map((projects) => 
         ...
         <NavLink to = {projects.link}>
           ...
           alt="project shotpicture"
           className="pics h-full w-full object-fit zoom-container transition-all ease-3s"
         /></div> 
